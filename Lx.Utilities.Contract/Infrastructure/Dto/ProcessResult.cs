...
using Lx.Utilities.Contract.Infrastructure.Exceptions;
    ...
    public class ProcessResult : IDto {
        ...
        public ProcessResult(ProcessResultType type, IEnumerable<Exception> exceptions = null,
            ...
            if (HasExceptions && LogExcetions)
                Mediator.Default.Publish(this); // TODO: Assess the possibility of asynchronizing this mediator publish
        }
