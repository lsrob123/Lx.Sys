...
(function(global, factory) {
    ...
    function isValid(m) {
        if (m._isValid == null) {
            ...
            const parsedParts = some$1.call(flags.parsedDateParts, function(i) {
                return i != null;
            });
...
[${i}] `;
    ...
    function configFromArray(config) {
        var i, date, currentDate, yearToUse;
        const input = [];
        if (config._d) {
            return;
        }
    ...
    function Duration(duration) {
        ...
        const normalizedInput = normalizeObjectUnits(duration); // representation for dateAddRemove
